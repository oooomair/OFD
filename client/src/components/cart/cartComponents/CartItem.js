...
const CartItem = ({cartItem, removeItem}) => {
    ...
    const subtractFood = () => {
        ...
        fetch(
            `https://ofd.up.railway.app/carts/${cartItem._id}`,
          {
            method: 'PATCH',
    ...
    const onDelete = () => {
        ...
        fetch(
            `https://ofd.up.railway.app/carts/${cartItem._id}/${user._id}`,
            {
              method: 'DELETE'
            }
          ).then(res => {
  ...
  return (
    <div className='cart__cart-item' >
        <div className="cart__food-img">
            <img src={`https://ofd.up.railway.app/foods/images/${cartItem.food.image}`} alt="food" />
        </div>
